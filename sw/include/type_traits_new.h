...
/**
@brief Make a type volatile depending on a flag
@tparam T Type to make volatile
@tparam t_volatile Flag indicating if the resulting type is volatile
*/
template <typename T, bool t_volatile>
struct MakeVolatile;

template <typename T>
struct MakeVolatile<T, true>
{
    typedef T volatile type;
};

template <typename T>
struct MakeVolatile<T, false>
{
    typedef T type;
};
...
//
//// is_enum<T>
//template <class T> struct is_enum : public integral_constant<bool, __is_enum(T)> {}; // __is_enum() is a gcc compiler intrinsic
//template<class T> inline constexpr bool is_enum_v = is_enum<T>::value;
//
//// is_union<T>
//template <class T> struct is_union : public integral_constant<bool, __is_union(T)> {}; // __is_union() is a gcc compiler intrinsic
//template<class T> inline constexpr bool is_union_v = is_union<T>::value;
//
//// is_class<T>
//template<class T> struct is_class : integral_constant<bool, __is_class(T)> { }; // __is_class() is a gcc compiler intrinsic
//template<class T> inline constexpr bool is_class_v = is_class<T>::value;
//
//// is_base_of<T>
//template <class Base, class Derived> struct is_base_of : integral_constant<bool, __is_base_of(Base, Derived)> { }; // __is_base_of() is a gcc compiler intrinsic

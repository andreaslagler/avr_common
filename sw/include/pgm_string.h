...
class PgmString
{
    ...
    // warning: ISO C++ did not adopt string literal operator templates taking an argument pack of characters [-Wpedantic]
    // String literals are a non-standard extension in GCC

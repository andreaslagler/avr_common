...
int main(void)
{
    ...
    const List<Test> testList(testInit);
    ...
    
    {
        testPassed = true;
        Test::resetCounter();
        List<Test> x(testInit.begin(), testInit.end());
    ...
    {
        testPassed = true;
        testPassed &= HeapAllocator<>() == testList.getAllocator();
    }
